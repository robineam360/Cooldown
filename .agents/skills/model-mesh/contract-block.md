<!-- model-mesh contract block v2.1 (2026-09-23). Paste into the vault's session protocol; keep the
     wording; change only the ON/OFF switch word and nothing else. The rule itself lives in the skill. -->
...
review still a fresh agent (§2a). **Cross-family (GPT) review: ON.** — when ON, an Astra review is
