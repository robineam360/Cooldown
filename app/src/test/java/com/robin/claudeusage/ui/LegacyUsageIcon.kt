...
/**
 * A frozen copy of `UsageIcon` as it stood before CCRM-83 (Ring Renderer) moved its
 * drawing into [RingRenderer] (commit 394afcc). It is the oracle [RingRendererTest]
 * compares against pixel for pixel. **Never edit it** — a change here would move the
 * goalposts the extraction is measured against.
 */
object LegacyUsageIcon {
